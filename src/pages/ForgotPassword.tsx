...
export default function ForgotPassword() {
    ...
    const renderInitialForm = () => (
        <form onSubmit={handleSendOTP} className="w-full space-y-3 sm:space-y-4">
            <div className="mb-2 text-center md:text-left">
                <h2 className="text-xl font-bold text-[#12151C] dark:text-white">Reset Password</h2>
                <p className="text-xs text-[#5B6472] dark:text-gray-400 mt-0.5">Enter your details to reset your password</p>
            </div>
            ...
            <div className="space-y-1">
                ...
                <input
                    ...
                    className="login-input w-full px-3.5 py-2.5 bg-[#F7F8FA] dark:bg-[#12151C] border border-[#E2E6ED] dark:border-gray-700 focus:border-[#2C4FD6] focus:bg-white dark:focus:bg-[#12151C] focus:ring-4 focus:ring-[#2C4FD6]/10 rounded-xl text-[#12151C] dark:text-white text-sm font-medium transition-all shadow-xs hover:border-gray-400"
            ...
            <Captcha onVerify={setGeneratedCaptcha} className="pt-0.5">
                <input
                    ...
                    className="login-input w-28 h-10 bg-[#F7F8FA] dark:bg-[#12151C] border border-[#E2E6ED] dark:border-gray-700 focus:border-[#2C4FD6] rounded-xl text-center font-bold tracking-widest text-[#12151C] dark:text-white text-sm shadow-inner uppercase hover:border-gray-400 transition-all"
                    placeholder="----"
                />
            </Captcha>
            ...
            <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 bg-[#2C4FD6] hover:bg-[#2442B8] text-white font-bold text-sm rounded-xl shadow-md shadow-[#2C4FD6]/20 transition-all active:scale-[0.98] disabled:opacity-50 cursor-pointer"
            >
    ...
    const renderOtpStep = () => (
        <form onSubmit={handleVerifyOTP} className="w-full space-y-6 py-2">
            ...
            <button
                ...
                className="w-full py-3 bg-[#2C4FD6] hover:bg-[#2442B8] text-white font-bold text-sm rounded-xl shadow-md shadow-[#2C4FD6]/20 transition-all active:scale-[0.98] disabled:opacity-50 cursor-pointer"
            >
    ...
    return (
        <div className="fixed inset-0 h-screen w-screen bg-[#F7F8FA] dark:bg-[#12151C] flex items-center justify-center p-4 sm:p-6 font-sans overflow-hidden">
            ...
            <div className="bg-white dark:bg-[#161B26] rounded-2xl md:rounded-[32px] shadow-xl border border-[#E2E6ED] dark:border-gray-800 w-full max-w-4xl max-h-[92vh] flex flex-col md:flex-row overflow-hidden relative z-10 animate-fade-in-up">
                <div className="hidden md:flex md:w-1/2 bg-[#F4F6FB] dark:bg-[#1A1F2C] relative overflow-hidden flex-col justify-between p-8 lg:p-10 border-r border-[#E2E6ED] dark:border-gray-800">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-[#2C4FD6] rounded-[9px] flex items-center justify-center text-white font-bold text-xl shadow-md shrink-0">
                            O
                        </div>
                    ...
                    <div className="relative flex-1 flex items-center justify-center pointer-events-none min-h-0">
                        <img
                            src={officeWorkerImg}
                            alt="Welcome"
                            className="max-h-[240px] lg:max-h-[280px] w-auto object-contain drop-shadow-xl"
                        />
                    </div>
                </div>
                    ...
                    <div className="w-full max-w-sm">
                        <div className="mb-4 text-center md:text-left md:hidden">
                            <div className="flex items-center justify-center md:justify-start gap-2.5 mb-2">
                                <div className="w-8 h-8 bg-[#2C4FD6] rounded-[7px] flex items-center justify-center text-white font-bold text-base shadow-sm">
                                    O
                                </div>
