...
import { Search, Filter, Calendar, Mail, Loader2, ArrowLeft, UserMinus, LayoutGrid, List } from 'lucide-react';
...
export default function LeaveToday() {
    ...
    const filteredLeaves = employeesOnLeave.filter(leave => {
        ...
        return matchesName && matchesEmail && matchesRole && matchesLocation;
    });
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400">List of employees currently away from work</p>
                    </div>
                </div>
                ...
                viewMode === 'grid' ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        {filteredLeaves.map((leave, index) => {
                            const emp = leave.fullEmployee || {};
                            const profile = emp.employeeProfile || {};
                            const name = emp.name || leave.user?.name || 'Unknown';
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-gray-50 dark:bg-white/5 border-b border-gray-100 dark:border-white/5">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">Leave Dates</th>
