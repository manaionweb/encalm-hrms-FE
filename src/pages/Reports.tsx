...
//                         <div
//                             onClick={() => window.open(`${api.defaults.baseURL}/reports/monthly-attendance?tenantId=${tenantId}`)}
...
//                         </div>
//                         <div
//                             onClick={() => window.open(`${api.defaults.baseURL}/reports/salary-register?tenantId=${tenantId}`)}
//                             className="bg-white/10 hover:bg-white/20 transition-colors p-4 rounded-xl cursor-pointer backdrop-blur-sm border border-white/10"
//                         >
...
//                         </div>
//                         <div
//                             onClick={() => window.open(`${api.defaults.baseURL}/reports/leave-balance?tenantId=${tenantId}`)}
//                             className="bg-white/10 hover:bg-white/20 transition-colors p-4 rounded-xl cursor-pointer backdrop-blur-sm border border-white/10"
//                         >
